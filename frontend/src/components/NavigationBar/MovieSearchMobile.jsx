...
const SearchComponentMobile = () => {
  ...
  return (
    <div className="flex flex-col items-center relative">
      ...
      />
      <div className={`absolute z-10 top-full mt-1.5 w-[230px] bg-red-950 text-white rounded-lg shadow-md shadow-black overflow-y-auto max-h-[350px]  ${results.length === 0 ? 'hidden' : ''}`}>
